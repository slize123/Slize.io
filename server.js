...
let players = {};    // id -> { x, y, wood, stone, name }
let walls = [];      // { x, y, hp: 50 }
let resources = [];

// генерим стартовые ресурсы на карте
...
// проверка коллизии (стена или ресурс нельзя ходить)
...
// каждые 8 секунд респавним мало ресурсов
setInterval(() => {
